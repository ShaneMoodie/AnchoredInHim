...
namespace AnchoredinHim.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventID,Name,Date,Location")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventID,Name,Date,Location")] Event @event)
        {
            if (ModelState.IsValid)
            {
